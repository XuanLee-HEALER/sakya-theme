...
function M.load()
  ...
  hi("DiffAdd",      { bg = "#283332" })
  hi("DiffChange",   { bg = "#2A2930" })
  hi("DiffDelete",   { bg = "#331F2D" })
  hi("DiffText",     { bg = "#3A3532" })
  ...
  hi("DiagnosticVirtualTextError", { fg = c.marpo,   bg = "#241C2B" })
  hi("DiagnosticVirtualTextWarn",  { fg = c.ngangpa, bg = "#24222B" })
  hi("DiagnosticVirtualTextInfo",  { fg = c.ngonpo,  bg = "#1F202E" })
  hi("DiagnosticVirtualTextHint",  { fg = c.dulba,   bg = "#22222E" })
